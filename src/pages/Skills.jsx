...
const Skills = () => {
  return (
    <motion.div
        ...
        className="w-screen h-auto no-scrollbar sm:h-screen flex items-center justify-center backdrop-blur-sm"
    >
          <Card className="w-full h-full no-scrollbar bg-card/50 border-0 rounded-none flex flex-col">
            <CardHeader>
